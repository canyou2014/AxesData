package com.cloudminds.smartrobot.bean;
...
public class AxisData {
	...
	public String toString() {
		Log.i("sensor#####################",  seq + "," + gyro_x + "," + gyro_y + "," + gyro_z+ "," + acc_x + "," + acc_y + "," + acc_z);
		return  Long.toString(System.currentTimeMillis() * 1000000) + "," + gyro_x * Math.PI / 180 + "," + gyro_y * Math.PI / 180 + "," + gyro_z * Math.PI / 180 + "," + acc_x + "," + acc_y + "," + acc_z;
	}
